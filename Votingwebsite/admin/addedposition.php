<?php 
    ...
    $sql2 = "SELECT postname from `post` WHERE postname = '$posname'";
    $query2 = mysqli_query($status,$sql2);
    $row = mysqli_fetch_array($query2);
    
    if(!empty($posname) && $row==0){
        $sql = "INSERT INTO post(postname) values('$posname')";
            ...
            <html lang="en">
                ...
                <div class="content pt-5">
                    <div class="container-fluid" style="width: 50rem;">
                        ...
                        color: #ff0000;
                        "
                            > Unable to add post. Post may already exist or 
                            field entered may be empty or invalid. 
                            Please try again
                        </h4>
