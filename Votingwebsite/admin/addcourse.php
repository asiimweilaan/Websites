...
?>
    ...
    <html lang="en">
            ...
            <nav class="navbar navbar-expand-lg me-auto ms-auto w-50">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav justify-content-around" style="width: 100%;">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active fw-bold" href="./addcourse.php">Add Course</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="content pt-5">
            ...
            <form method="POST" action="addedcourse.php" class="form_bgcolor py-4 px-3" style="border-radius: 10px 10px 10px 10px;"> 
                    <div class="row mb-3">
                        <label for="inputEmail3" class="col-sm-2 col-form-label fw-bold text-white">Course Name</label>
                        <div class="col-sm-10">
                            <input name="course" type="text" class="form-control" id="inputPassword3"
