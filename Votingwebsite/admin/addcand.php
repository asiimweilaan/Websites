...
?>
    ...
    <html lang="en">
        ...
        <nav class="navbar bg-dark border-bottom border-body" data-bs-theme="dark">
            ...
            <a href="./addcandcheck.php"><img src="../img/img1.jpg" style="object-fit: cover; width: 50px; height: 50px;
        ...
        <div class="content pt-5">
            <div class="container-fluid" style="width: 50rem;">
                <form method="POST" action="addcandcheck.php" class="form_bgcolor py-4 px-3" style="border-radius: 10px 10px 10px 10px;"> 
                    <div class="row mb-3">
                        <label for="inputEmail3" class="col-sm-2 col-form-label fw-bold text-white">Name</label>
                        <div class="col-sm-10">
                    ...
                    <div class="row mb-3">
                        <label for="inputPassword3" class="col-sm-2 col-form-label fw-bold text-white">Email</label>
                        <div class="col-sm-10">
                    ...
                    <div class="row mb-3">
                        <label for="inputPassword3" class="col-sm-2 col-form-label fw-bold text-white">Position</label>
                        <div class="col-sm-10">
                            <select class="col-sm-12" name="position">
                                <?php
                                    $sql = "SELECT postname FROM `post`";
                                ...
                                ?>
                                    ...
                                    <option class="col-sm-10" value="<?php print($x[0])?>"><?php print($x[0])?></option>
                    ...
                    <div class="row mb-3">
                        <label for="inputPassword3" class="col-sm-2 col-form-label fw-bold text-white">Course</label>
                        <div class="col-sm-10">
                            <select class="col-sm-12" name="course">
                                <?php
                                    $sql2 = "SELECT cname FROM `course`";
                                    $query2 = mysqli_query($status,$sql2);
                                    $array_res2 = mysqli_fetch_all($query2);
                                    
                                    foreach($array_res2 as $x){
                                ?>
                                    
                                    <option value="<?php print($x[0])?>"><?php print($x[0])?></option>
